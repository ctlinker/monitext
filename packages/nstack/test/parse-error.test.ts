        ...
        expect(
            interpretErrorStack(
                createErrorWithStack(
                    [
                        "Error: boom",
                        "    at /home/cat/project/src/index.ts:12:8",
                    ].join("\n")
                )
            )
        ).toEqual([
        ...
        expect(
            interpretErrorStack(
                createErrorWithStack(
                    [
                        "Error: boom",
                        "    at readConfig (/home/cat/with space/app.ts:44:2)",
                    ].join("\n")
                )
            )
        ).toEqual([
        ...
        expect(
            interpretErrorStack(
                createErrorWithStack(
                    [
                        "Error: boom",
                        "prefix /tmp/file.js@myprefix:12:3",
                    ].join("\n")
                )
            )
        ).toEqual([
        ...
        expect(
            interpretErrorStack(
                createErrorWithStack(
                    [
                        "Error: boom",
                        "    at load (C:\\Program Files\\My App\\index.js:20:5)",
                    ].join("\n")
                )
            )
        ).toEqual([
